        ...
        return __generator(this, function (_l) {
            switch (_l.label) {
                ...
                case 4:
                    ...
                    _l.label = 5;
                case 5:
                    logger.info("initialized config for a candy machine with publickey: ".concat(res.candyMachine.toBase58()));
                    (0, cache_1.saveCache)(cacheName, env, cacheContent);
                    return [3 /*break*/, 7];
                case 6:
                    exx_1 = _l.sent();
                    logger.error('Error deploying config to Solana network.', exx_1);
                    throw exx_1;
                case 7: return [3 /*break*/, 9];
                case 8:
                    logger.info("config for a candy machine with publickey: ".concat(cacheContent.program.candyMachine, " has been already initialized"));
                    _l.label = 9;
                case 9:
                    uploadedItems = Object.values(cacheContent.items).filter(function (f) { return !!f.link; }).length;
                    logger.info("[".concat(uploadedItems, "] out of [").concat(totalNFTs, "] items have been uploaded"));
                    if (dedupedAssetKeys.length) {
                        logger.info("Starting upload for [".concat(dedupedAssetKeys.length, "] items, format ").concat(JSON.stringify(dedupedAssetKeys[0])));
                    }
                            ...
                            return __generator(this, function (_f) {
                                switch (_f.label) {
                                    ...
                                    case 7:
                                        ...
                                        return [3 /*break*/, 10];
                                    case 8: return [4 /*yield*/, (0, arweave_1.arweaveUpload)(logger, walletKeyPair, anchorProgram, env, image, manifestBuffer, manifest, asset.index)];
                                    case 9:
                ...
                case 44:
                    ...
                    return [4 /*yield*/, writeIndices(logger, {
                ...
                case 46:
                    ...
                    _l.label = 47;
                case 47:
                    if (!(callbackUrl && guid)) return [3 /*break*/, 49];
                    logger.info("Sending post request to Callback URL: ".concat(callbackUrl));
                    return [4 /*yield*/, axios_1["default"].post(callbackUrl, { candyMachineId: candyMachine, creator: walletKeyPair.publicKey.toBase58(), guid: guid })];
                case 48:
                    _l.sent();
                    _l.label = 49;
                case 49:
                    logger.info("Done. Successful = ".concat(uploadSuccessful, "."));
 ...
 */
function writeIndices(logger, _a) {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    logger.info("Writing all indices in ".concat(poolArray.length, " transactions..."));
